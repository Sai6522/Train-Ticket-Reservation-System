...
@WebServlet("/testupdatetrain")
public class TestUpdateTrain extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			pw.println("<h2>Train Update Test</h2>");
			...
			pw.println("<p><strong>Update Result: " + message + "</strong></p>");
			
			pw.println("<p><a href='QuickUpdateTest.html'>Back to Test Page</a></p>");
